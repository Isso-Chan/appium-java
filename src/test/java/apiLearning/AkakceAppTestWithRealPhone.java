...
import Util.MobileCapabilityTypeEx;
...
public class AkakceAppTestWithRealPhone {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            desiredCapabilities.setCapability(MobileCapabilityTypeEx.APP_PACKAGE, "com.akakce.akakce"); //See ReadMe
            desiredCapabilities.setCapability(MobileCapabilityTypeEx.APP_ACTIVITY, "com.akakce.akakce.ui.splash.SplashActivity"); //See ReadMe
            desiredCapabilities.setCapability(MobileCapabilityTypeEx.NEW_COMMAND_TIMEOUT, 30);
            ...
            WebElement goToSellerButton = appiumDriver.findElement(By.xpath("//android.view.View[@content-desc=\"Satıcıya Git\"]/android.view.View"));
